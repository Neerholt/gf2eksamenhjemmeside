...
$sql_tabel = "INSERT INTO `lavopskrift`(`ID`, `Antal`, `Madret`, `Besked`) VALUES (NULL,'$name','$efternavn','$besked')";

$data = mysqli_query($connect,$sql_tabel);


header("location:dataconfirmup.php");
...
<!--Start:Det her er style til mine textfelter-->
<style>
.idk {
  background-color: #EEE; 
  border: none;
...
.idk {background-color: #EEE;} 

</style>
<!--Slut:Det her er style til mine textfelter-->
 ...
 <!--Hele hjemmesidens layout slut-->     
        <div id="container"><!--The start of my div "container"-->
            <div id="header"><!--The start of my div "header" -->
                <h1><strong>Upload Opskrif til "Morgenmad"</strong></h1>
            </div><!--The ending of my div "header"-->
             <div id="nav"><!--The start of my div "nav"-->
                <center><h2>Admin panel</h2></center>
                
                <form method="POST" action="opskriftindsendt.php">
                <input class="logincss" type="submit" name="logut" value="Se indsendt opskrifter">
               </form>
                ...
                <input class="logincss" type="submit" name="Brugerlog" value="Lav nyt bruger login">
                </form>
                ...
                <input class="logincss" type="submit" value="Slet en opskrift">
                </form>
                ...
                <form method="POST" action="">
                <input class="logincss" type="submit"  value="Nulstil">
                  </form>
                ...
                <hr>
                <h2>Opskrift type.</h2></center>
                <select class="logincss"><center>
                    <option value="Morgenmad">Morgenmad</option>
                    <option value="Middagsmad">Middagsmad</option>
                    <option value="aftensmad">Aftensmad</option>
                   <option value="opel">Kage</option>
                   <option value="audi">Is</option>
                   <option value="audi">Desserter</option>
                   </select>
                <br/><br/>
           ...
           <div id="main"><!--The start of my div "main"-->   
                <div id="main"><!--Div start main-->
                    <div class="ex1"><!--Div start More recipes -->
                        <div id="information"><!--Starten på mit div hvor en bruger kan give mig deres navn, efternavn og en besked-->
                            
                            <center><form method="POST" action="">
                                    <h3>Madrettens navn</h3>
                                    <input type="text"  class="idk" name="navn" placeholder="Madrettens navn" required> 
                                    <h3>Antal persons anretning</h3>
                                    <input type="number"  class="idk" name="efternavn" placeholder="Antal persons anretninger" required> 
                                    <hr>
                                    <h3>Textbox til indskrivning af jers opskrifter.</h3>
                                    <center><textarea rows="15" class="idk" name="besked" cols="50" placeholder="Skriv jers opskrift her." required></textarea></center>
                                    <br>
                                    <form method="POST" action="uploadetopskrift.php">
                                    <input class="logincss" type="submit" name="GEM" value="Offentliggøre opskrift">
                                    </form>
                          </form></center>  
                        </div><!--slutning på mit div hvor en bruger kan give mig deres navn, efternavn og en besked-->
