...
$sql_tabel = "INSERT INTO `indsendop`(`ID`, `Navn`, `Efternavn`, `Besked`) VALUES (NULL,'$name','$efternavn','$besked')";

$data = mysqli_query($connect,$sql_tabel);


header("location:dataconfirmind.php");
 ...
 <!--Hele hjemmesidens layout slut-->     
        <div id="container"><!--The start of my div "container"-->
            <div id="header"><!--The start of my div "header" -->
                <h1><strong>Indsend Opskrift.</strong></h1>
                    ...
                    <div class="ex1"><!--Div start More recipes -->
                        <div id="information"><!--Starten på mit div hvor en bruger kan give mig deres navn, efternavn og en besked-->
                            ...
                            <center><form method="POST" action="">
                                    <h3>Navn</h3>
                                    <input type="text"  class="idk" name="navn" placeholder="Navn" required > 
                                    <h3>Efternavn</h3>
                                    <input type="text"  class="idk" name="efternavn" placeholder="Efternavn"required > 
                                    <hr>
                                    <h3>Her kan du skrive din opskrift ind</h4>
                                    <center><textarea rows="15" class="idk" name="besked" cols="50" placeholder="Skriv din opskrift her." required></textarea></center>
                                    <br/>
                                    <button class="logincss" type="submit" name="GEM">Indsend opskrift</button>
